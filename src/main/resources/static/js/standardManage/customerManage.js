var customerManageTable = new Tabulator("#customerManageTable", {
    ...
    columns:[
        ...
        {title:"사업자 등록번호", field:"registrationNumber", headerFilter:"input"},
        {title:"주소", field:"address", headerFilter:"input"},
        {title:"담당자", field:"manager", headerFilter:"input"},
        {title:"담당자 전화번호", field:"managerPhone", headerFilter:"input"},
        {title:"담당자 이메일", field:"managerEmail", headerFilter:"input"},
